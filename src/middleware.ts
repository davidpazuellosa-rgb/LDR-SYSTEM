...
export const config = {
  matcher: [
    // Roda em tudo, menos: rotas de API, as páginas públicas de convite (definir-senha)
    // e de recuperação de senha (recuperar-senha),
    ...
    "/((?!api|definir-senha|recuperar-senha|_next/static|_next/image|favicon.ico|.*\\.(?:png|jpg|jpeg|svg|gif|webp|ico)).*)",
  ],
};
